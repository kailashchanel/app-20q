  ...
  return (
    <>
      ...
      <Screen style={styles.screen}>
        ...
        {preConditionFailed && (
          <>
            <Text style={styles.text}>Take the survey to see your recommendations!</Text>
            <Button title="Take me to the survey!" onPress={() => navigation.navigate(routes.SURVEY)} />
            <Button color="secondary" title="Press me when you're done!" onPress={loadComparisons} />
          </>
        )}
        {comparisons && 
        <>
